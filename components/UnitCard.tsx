...
function excelDateToString(raw: string): string {
  ...
  // Excel serial: dias desde 1900-01-00 (com bug do ano 1900)
        ...
        <div className="flex justify-between items-start mb-6">
          <div className="flex items-start gap-4 sm:gap-5">
            ...
            <div className="flex flex-col gap-2 pt-1 sm:pt-2">
              ...
              <span className="text-xs sm:text-sm font-bold text-slate-400">Cód. {unit.codUnidade}</span>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-3 relative z-10">
        ...
        <div className="grid grid-cols-2 gap-3 pt-3 border-t border-slate-100">
          <div className="flex items-center gap-2">
            <CalendarDays className="w-4 h-4 text-[#f08228] shrink-0" />
            <div>
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Inauguração</p>
              <p className="text-sm text-slate-700 font-bold">{excelDateToString(unit.inauguracao)}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Waves className="w-4 h-4 text-[#2fabab] shrink-0" />
            <div>
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Piscina</p>
              <p className="text-sm text-slate-700 font-bold">{unit.piscina}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Clapperboard className="w-4 h-4 text-[#c23c8e] shrink-0" />
            <div>
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Studios</p>
              <p className="text-sm text-slate-700 font-bold">{unit.studios}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Activity className="w-4 h-4 text-[#2fabab] shrink-0" />
            <div>
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Wellhub</p>
              <p className="text-sm text-slate-700 font-bold">{unit.wellhub}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Users className="w-4 h-4 text-[#f08228] shrink-0" />
            <div>
